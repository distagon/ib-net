...
namespace IBNet
{
    public interface ITWSEncoding
    {
        ...
        bool DecodeBool();
        Messages.Client DecodeClientMessage();
        ...
        int DecodeInt();
        long DecodeLong();
        IBOrderType DecodeOrderType();
        IBSecType DecodeSecType();
        DateTime DecodeExpiryDate();
        Messages.Server DecodeServerMessage();
        string DecodeString();
        IBTimeInForce DecodeTif();
        void Encode(IBAction action);
        void Encode(bool value);
        void Encode(IBOrderType orderType);
        void Encode(IBTimeInForce tif);
        void Encode(IBSecType secType);
        void Encode(TWSServerInfo info);
        void Encode(string text);
        void Encode(Messages.Server msg);
        void Encode(Messages.Client msg);
